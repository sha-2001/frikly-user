...
`
export const HardwareDropContainer = styled.div`
    padding-left : 18%;
`
export const AppliancesDropContainer = styled(HardwareDropContainer)`
`
export const SanitarywareDropContainer = styled(HardwareDropContainer)`
`
export const LaminatesDropContainer = styled(HardwareDropContainer)`
`
