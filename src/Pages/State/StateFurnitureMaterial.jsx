...
import WpIcon from '../../assets/Products/whatsapp-icon.webp'
  ...
  return (
    <>
      <div className="state-template">
        <p className="state-furniture-text1">
          <span>{heading}</span>
        </p>
      ...
      <div className="state-furniture">
        ...
        <div className="state-furniture-col3">
          ...
          <div className="state-furniture-col3-row2">
            <p className="share-material-text">
              Share your material <br />
              list or your product <br />
              requirements & we <br />
              will send you the <br />
              lowest possible quote
            </p>
            <button>
              <span className="contact-share-icon">
                <img src={WpIcon} alt=".." />
              </span>
              Contact
            </button>
