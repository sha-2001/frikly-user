          ...
          <CartDescription>
            <OfferList>
              ...
              <p className="offerlist-text">
                Get Free <span className="offerlist-text-span1">Shipping</span>{" "}
                for orders over{" "}
                <span className="offerlist-text-span2">$10,000.00</span>
              </p>
            </OfferList>
            <MyCart>
            ...
            <PriceDetails>
              ...
              <table>
                ...
                <tr>
                  ...
                  <td className="price-details-value not-applied">
                    Not Applied
                  </td>
                </tr>
                <tr>
